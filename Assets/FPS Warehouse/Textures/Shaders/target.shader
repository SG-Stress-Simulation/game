...
Shader "Shader Forge/target" {
    Properties {
        _Color ("Color", Color) = (1,1,1,1)
        _node_9536 ("node_9536", 2D) = "white" {}
        _node_8207 ("node_8207", Range(0, 1)) = 0
        _node_8207_copy ("node_8207_copy", Range(0, 1)) = 0
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                float4 _node_9536_var = tex2D(_node_9536,TRANSFORM_TEX(i.uv0, _node_9536));
                clip((_node_9536_var.a*0.7) - 0.5);
...
////// Specular:
                ...
                float3 diffuseColor = (_Color.rgb*_node_9536_var.rgb); // Need this for specular when using metallic
                float specularMonochrome;
                float3 specularColor;
                diffuseColor = DiffuseAndSpecularFromMetallic( diffuseColor, _node_8207, specularColor, specularMonochrome );
