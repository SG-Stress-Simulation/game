...
Shader "Custom/chrome 1"
{
	...
	SubShader
	{
		...
		{
			float3 worldrefVec2 = i.worldRefl;
			o.Albedo = texCUBE( _cubemap2,worldrefVec2).xyz;
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=6001
2567;29;1666;974;911;385;1;True;True
Node;AmplifyShaderEditor.WorldReflectionVector;2;-697,-81;Float;False;0;FLOAT3;0,0,0;False;FLOAT3;FLOAT;FLOAT;FLOAT
