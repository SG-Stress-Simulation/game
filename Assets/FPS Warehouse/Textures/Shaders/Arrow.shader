...
Shader "Shader Forge/Arrow" {
    ...
    SubShader {
        ...
        Pass {
            ...
            uniform sampler2D _node_9329; uniform float4 _node_9329_ST;
            struct VertexInput {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float4 _node_9329_var = tex2D(_node_9329,TRANSFORM_TEX(i.uv0, _node_9329));
                float3 node_5776 = (1.0 - _node_9329_var.rgb);
                clip(node_5776.r - 0.5);
...
/////// Diffuse:
                ...
                float3 diffuseColor = (_Color.rgb*node_5776);
