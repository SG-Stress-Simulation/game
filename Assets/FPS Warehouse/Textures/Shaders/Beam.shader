...
Shader "Shader Forge/Beam" {
    Properties {
        ...
        _node_6695 ("node_6695", 2D) = "white" {}
        _node_1661 ("node_1661", Cube) = "_Skybox" {}
        _node_4736 ("node_4736", 2D) = "white" {}
    }
    SubShader {
        Tags {
            "RenderType"="Opaque"
        ...
        Pass {
            ...
            uniform sampler2D _node_6695; uniform float4 _node_6695_ST;
            struct VertexInput {
...
////// Specular:
                ...
                float4 _node_6695_var = tex2D(_node_6695,TRANSFORM_TEX(i.uv0, _node_6695));
                float3 diffuseColor = (_node_6695_var.rgb*_Color.rgb); // Need this for specular when using metallic
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float4 _node_6695_var = tex2D(_node_6695,TRANSFORM_TEX(i.uv0, _node_6695));
                float3 diffColor = (_node_6695_var.rgb*_Color.rgb);
                float specularMonochrome;
                float3 specColor;
